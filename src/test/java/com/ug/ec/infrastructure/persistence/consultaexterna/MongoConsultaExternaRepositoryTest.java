...
class MongoConsultaExternaRepositoryTest {
    ...
    void findById_DebeRetornarConsulta_CuandoExiste() {
        ...
        // Act
        Optional<ConsultaExterna> consultaEncontrada = repository.findById(consultaGuardada.getId());
    ...
    void findById_DebeRetornarEmpty_CuandoNoExiste() {
        // Act
        Optional<ConsultaExterna> consultaEncontrada = repository.findById("id-inexistente");
    ...
    void findByNumeroConsulta_DebeRetornarConsulta_CuandoExiste() {
        ...
        // Act
        Optional<ConsultaExterna> consultaEncontrada = repository.findByNumeroConsulta("CE-123456");
    ...
    void findByDatosPacienteCedula_DebeRetornarConsultas() {
        ...
        // Act
        Page<ConsultaExterna> consultasPage = repository.findByDatosPacienteCedula("0987654321", pageable);
    ...
    void deleteById_DebeEliminarConsulta() {
        ...
        Optional<ConsultaExterna> consultaRecuperada = repository.findById(id);
    ...
    void findByDatosConsultaFechaConsultaBetween_DebeRetornarConsultasEnRango() {
        ...
        // Act
        Page<ConsultaExterna> consultasPage = repository.findByDatosConsultaFechaConsultaBetween(
