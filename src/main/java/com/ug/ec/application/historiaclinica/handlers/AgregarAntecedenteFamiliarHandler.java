...
import com.ug.ec.application.historiaclinica.commands.AgregarAntecedenteFamiliarCommand;
...
public class AgregarAntecedenteFamiliarHandler {

    private final HistoriaClinicaRepository repository;

    @Transactional
    public HistoriaClinica ejecutar(AgregarAntecedenteFamiliarCommand command) {
        ...
        historiaClinica.agregarAntecedenteFamiliar(
